...
import 'package:world_metro/view/initializer/widget/button.dart';
import 'package:world_metro/view/worldMap/worldMap.dart';
...
class Initializer1 extends StatefulWidget {
  const Initializer1({super.key});

  @override
  State<Initializer1> createState() => _Initializer1State();
}

class _Initializer1State extends State<Initializer1>
        ...
        body: Container(
            decoration: const BoxDecoration(
              image: DecorationImage(
                  image: AssetImage('assets/world_train.jpg'), fit: BoxFit.cover),
            ),
            child: Scaffold(
