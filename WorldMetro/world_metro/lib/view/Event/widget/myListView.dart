...
import 'package:world_metro/view/Detail/detailEvents.dart';
import 'package:world_metro/view/Event/widget/rating_widget.dart';
...
class _MyListView2State extends State<MyListView2> {
  ...
  Widget build(BuildContext context) {
    ...
    String city = cities.selectedCity;

    
    List eventDatas = CityEventData.cities[city];
